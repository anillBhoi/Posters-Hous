...
export const posters: Poster[] = [
  {
    ...
    description:
      "A mesmerizing abstract piece featuring flowing gold and copper metallic waves against a deep charcoal backdrop. This artwork brings a sense of luxury and movement to any space.",
    category: "abstract",
    image: goldenWaves,
    sizes: [
  ...
  },
  {
    ...
    description:
      "A serene Japanese ink wash landscape featuring misty mountains and a lone pine tree. Inspired by traditional sumi-e painting techniques, this piece evokes tranquility and contemplation.",
    category: "nature",
    image: zenMountains,
    sizes: [
  ...
  },
  {
    ...
    artist: "Marcus Weber",
    description:
      "Bold geometric forms in warm terracotta, burnt orange, and sage green create a mid-century modern masterpiece. Inspired by Bauhaus principles of form and color.",
    category: "abstract",
  ...
  },
  {
    ...
    artist: "Elena Flores",
    description:
      "Ethereal watercolor botanicals featuring delicate wildflowers and grasses in soft, muted tones. A feminine and elegant piece that brings natural beauty indoors.",
    category: "botanical",
  ...
  },
  {
    ...
    description:
      "A dramatic seascape capturing the raw power of nature. Deep navy waters and crashing waves create a moody, atmospheric piece with cinematic presence.",
    category: "nature",
    image: stormySeas,
    sizes: [
  ...
  },
  {
    ...
    description:
      "A sophisticated continuous line drawing capturing the essence of feminine elegance. Minimalist yet expressive, this piece makes a refined statement.",
    category: "minimalist",
    image: linePortrait,
    sizes: [
  ...
  },
  {
    ...
    artist: "David Chen",
    description:
      "A stunning architectural photograph of a spiral staircase, shot from below. The dramatic black and white tones and geometric patterns create a hypnotic visual experience.",
  ...
  },
  {
    ...
    artist: "Aurora Night",
    description:
      "A mystical crescent moon glowing through cosmic clouds and stars. This ethereal piece brings the magic of the night sky into your space.",
    category: "celestial",
...
export const getFeaturedPosters = (): Poster[] => posters.filter((p) => p.isFeatured);
export const getNewArrivals = (): Poster[] => posters.filter((p) => p.isNew);
export const getPostersByCategory = (category: string): Poster[] =>
  posters.filter((p) => p.category === category);
export const getPosterById = (id: string): Poster | undefined => posters.find((p) => p.id === id);
